...
significant (see also the NIC (News Impact Curve)).
Obtained as a special case of the Family-GARCH, the T-GARCH model is
estimated:
...
models at a time, evaluating which is the best among them.
Volatility:
...
December 2021 in which the financial
markets are open. In table the forecast values:
